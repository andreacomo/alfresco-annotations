...
/**
 * Activiti OnCreateTaskListener annotation validator.
 *
 ...
 *
 * Note: The class stop the compilation because TaskListener it meant to be used to register an activiti bean which is a org.activiti.engine.delegate.TaskListener
 *
 * @author Alberto Rugnone
 */
public class OnCreateTaskListenerValidator extends AbstractProcessor {
    ...
    public Set<String> getSupportedAnnotationTypes() {
        return ImmutableSet.of(OnCreateTaskListener.class.getCanonicalName());
    }
}
